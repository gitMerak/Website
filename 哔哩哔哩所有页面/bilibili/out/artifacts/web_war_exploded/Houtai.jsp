    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        ...
        <TR>
          ...
          onClick="javascript:if (confirm('查看该信息？')) location.href='static/Xinxi.jsp';else return;">查看</BUTTON>
          <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('编辑该信息？')) location.href='static/Xinxi.jsp';else return;">编辑
          </BUTTON> <BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('通过审核？')) location.href='static/Xinxi.jsp';else return;">审核</BUTTON></TD>
        </TR>
			</c:forEach>
      </table>
    </div>
